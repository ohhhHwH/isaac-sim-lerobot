...
from .kochsim_marl_env_cfg import KochsimMarlEnvCfg


class KochsimMarlEnv(DirectMARLEnv):
    cfg: KochsimMarlEnvCfg

    def __init__(self, cfg: KochsimMarlEnvCfg, render_mode: str | None = None, **kwargs):
