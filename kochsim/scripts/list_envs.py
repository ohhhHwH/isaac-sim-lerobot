...
All the environments are registered in the `kochsim` extension. They start
...
import kochsim.tasks  # noqa: F401


def main():
    """Print all environments registered in `kochsim` extension."""
